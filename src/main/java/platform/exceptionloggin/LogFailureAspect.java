        ...
        try {
            ...
            try {
                ...
                FailureContext context = FailureContext.builder()
                        ...
                        .build();
                ReportingGuard.report(reporter, error, context);
            } catch (Throwable reportingPreparationFailure) {
                ReportingGuard.rethrowFatal(reportingPreparationFailure);
                ReportingGuard.addSuppressed(error, reportingPreparationFailure);
            }
            throw error;
        }
    }
